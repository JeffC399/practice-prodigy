...
import { WhatsNewTrigger } from "./whats-new";
...
export function SiteFooter() {
  return (
    <footer
      data-site-footer
      className="sticky bottom-0 z-30 flex flex-wrap items-center justify-between gap-3 border-t border-border bg-background px-4 py-2 font-mono text-[11px] text-muted-foreground sm:px-6"
    >
      ...
      <div className="flex flex-nowrap items-center gap-4 whitespace-nowrap leading-none">
        {/* Phase 44 — "What's new" release-notes modal + trigger.
            Auto-opens once per new release; footer button reopens
            any time. */}
        <WhatsNewTrigger />
